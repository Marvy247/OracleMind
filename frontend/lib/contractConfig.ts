...
export const AIAgentAddress = "0xC79157189380c3b5ab7fF25f622DaA1e2Cf5FcB5" as `0x${string}`;
export const TaskMarketplaceAddress = "0x65bfDa8Eb3eeD4b90240C7640D0B49450a83E021" as `0x${string}`;
export const GameSimulatorAddress = "0x0b93c6Ce4A04dce967cB0fA0b046001c49F2AD02" as `0x${string}`;
